...
function Storefront() {
  ...
  if (page === 'store') return <>{sharedHeader}<StorePage onQuickView={setQuickViewProduct} onProductClick={openProduct} /><NewsletterOffer {...newsletterOffer} onSubmit={(email) => console.info('Suscripción solicitada:', email)} /><Footer {...footerData} />{sharedQuickView}</>;
