import gamingLaptopImage from '../assets/promos/gaming-laptop.png';
import solarInverterImage from '../assets/promos/solar-inverter.png';
import cctvDomeImage from '../assets/promos/cctv-dome.png';
...
export const homePromoBanners: PromoBannerItem[] = [
  ...
  { id: 'security-solutions', title: 'Protege tus espacios con CCTV inteligente', ctaLabel: 'Ver seguridad', image: cctvDomeImage, imageAlt: 'Sistema de seguridad CCTV con cámara domo', backgroundColor: '#e6ebf2', textColor: '#092548', ctaColor: '#1a2989', href: '#categoria-sistemas-cctv' },
];
