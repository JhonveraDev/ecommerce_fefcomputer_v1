...
export const footerData: FooterProps = {
  ...
  columns: [
    { title: 'Empresa', links: [{ label: 'Nosotros', href: '#nosotros' }, { label: 'Información de envíos', href: '#envios' }, { label: 'Política de privacidad', href: '#privacidad' }, { label: 'Términos y condiciones', href: '/terminos-y-condiciones' }, { label: 'Contáctanos', href: '#contacto' }, { label: 'Centro de ayuda', href: '#ayuda' }, { label: 'Trabaja con nosotros', href: '#empleo' }] },
