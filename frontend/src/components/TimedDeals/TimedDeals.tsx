...
type Product = { id: string; slug: string; name: string; brand: string; price: number; previousPrice: number | null; offerStartsAt?: string | null; offerEndsAt?: string | null; rating: number; reviewCount: number };
