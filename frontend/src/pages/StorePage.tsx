...
export function StorePage({ products, onQuickView, onProductClick, onAddToCart, locationPath }: Props) {
  ...
  return <main>
    ...
    <section className={styles.layout}>
      <StoreSidebar products={products} selectedCategory={category} onCategorySelect={selectCategory} onProductClick={onQuickView} />
      <div className={styles.catalog}>
        ...
        {!search && <TimedDeals products={products} onProductClick={(product) => onProductClick(product as Product)} onAddToCart={(product) => onAddToCart(product as Product)} />}
      </div>
    </section>
  </main>;
}
