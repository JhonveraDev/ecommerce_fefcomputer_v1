...
import { AlignLeft, BadgeCheck, Barcode, Boxes, ChevronRight, CircleDollarSign, Home, LayoutGrid, PackageCheck, Plus, ShoppingCart, Sparkles, Tag, Trash2, X } from 'lucide-react';
