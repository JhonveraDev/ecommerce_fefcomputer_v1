...
const include = { brand: true, categories: { include: { category: true }, orderBy: { isPrimary: 'desc' }, take: 1 }, images: { orderBy: { position: 'asc' } }, inventory: true, variants: { include: { inventory: true } }, relatedFrom: { select: { relatedProductId: true }, orderBy: { position: 'asc' } } };
